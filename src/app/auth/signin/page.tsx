        ...
        <div className="relative rounded-2xl border border-white/10 bg-white/10 backdrop-blur-xl px-7 py-8 shadow-[0_0_0_1px_rgba(255,255,255,0.08),0_10px_40px_-10px_rgba(0,0,0,0.55)]">
          ...
          <div className="relative flex flex-col gap-6">
            <div className="text-center space-y-2">
              <h1 className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 via-fuchsia-300 to-emerald-300">Sign In</h1>
              <p className="text-xs text-indigo-100/70">Welcome back. Keep the momentum going.</p>
            </div>
            <SignInForm />
            <p className="text-xs text-indigo-100/70 text-center">Need an account?{' '}<Link href="/auth/signup" className="font-medium text-indigo-200 hover:text-fuchsia-200 underline underline-offset-4">Create one</Link></p>
          </div>
        </div>
      </div>
    </main>
