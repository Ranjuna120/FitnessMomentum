    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative px-6 pt-10 pb-10 md:pb-14 overflow-hidden">
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          ...
          <Link href="/dashboard/metrics/new" className="relative text-sm shadow-lg inline-flex items-center gap-2 px-5 py-2 rounded-full font-medium text-white bg-gradient-to-r from-indigo-500 via-fuchsia-500 to-emerald-500 bg-[length:300%_300%] animate-[pulseGradient_6s_ease_infinite] hover:scale-[1.03] transition">Add Metric</Link>
        </div>
